...
<!-- css link -->
	<link rel="stylesheet" type="text/css" href="2header_css.css">
<!-- 반응형 웹 관련 link -->	
	<link rel="stylesheet" media="screen and (max-width: 768px)" href="2header_css.css" />
<!-- font link -->
	<link href="https://fonts.googleapis.com/css2?family=Nanum+Gothic:wght@700&display=swap" rel="stylesheet">
<!-- java script -->
	<script src="2header_js.js" defer></script>
</head> 
<meta charset="UTF-8">
<title>Nav Bar</title>
</head>
<body>
	<nav class="navbar">
		<div class="navbar_logo">
			<a href="#"><img class="main_logo" src="images/logo_icon.png">너나들이</a>
