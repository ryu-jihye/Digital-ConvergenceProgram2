...
<div class="card-container">
   ...
   <!--      <img src="../images/card1.mp4" alt=""> -->
        <div class="video">
    	<video src="../images/card1.mp4" loop muted autoplay height="250" width="400"></video>
		</div>
        <div class="content">
            <h3 class="title">Middle-East Asia</h3>
    ...
    <div class="card">
       <!--  <img src="../images/card2.mp4" alt=""> -->
        <div class="video">
    	<video src="../images/card2.mp4" loop muted autoplay height="250" width="400"></video>
		</div>
        <div class="content">
    ...
    <div class="card">
        ...
        <!-- <img src="../images/card3.mp4" alt=""> -->
        <div class="video">
    	<video src="../images/card3.mp4" loop muted autoplay height="250" width="400"></video>
		</div>
        <div class="content">
